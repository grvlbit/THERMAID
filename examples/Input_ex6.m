...
udata.Fix(1:udata.Nf(2)) = 4.9646e+05;
udata.Fix(udata.Nf(2)+1:2*udata.Nf(2))=-4.9646e+05;
...
global k_ratio
a = 0.05;
udata.K       = ones(udata.Nf(1),udata.Nf(2))*1e-12; 	    % permeability field [m2]
udata.K_f     = ones(udata.Nf_f,1)*1e-12*k_ratio; 	        % fracture permeability field [m2]
